...
| 1Sat origin and sat ordering | [BRC-300](./0300.md) |
...
* Outside the inscription — APIs, storage, comparison — implementations normalize to a single string form. [BRC-36](../outpoints/0036.md) uses `<txid>.<vout>`.
...
The `ord` envelope is only the **carrier** for the BSV-21 JSON payload. Token identity, transfers, mints, and burns follow the UTXO balance and authority rules in this document — **not** [BRC-300](./0300.md) sat ordering or origin tracking.
