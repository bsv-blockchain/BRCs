...
its state is encoded — for the latter see BRC-171.
...
- BRC-171 — Fixed-Width State in a Covenant's Own Locking Script; the state layout used by both instances above
