...
| --------------- | ---- | -------- | --------- |
| `0100BEEF` | `uint32` LE (4022206465) | BEEF | [BRC-62](./0062.md) |
| `0200BEEF` | `uint32` LE (4022206466) | BEEF V2 (TXID-only extension) | [BRC-96](./0096.md) |
| `01010101` | 4-byte prefix (32-byte subject TxID follows) | Atomic BEEF | [BRC-95](./0095.md) |
...
- **Open / public / anonymous ingress** MUST set `DeliverCount = 1`. One
  deliverable topic per anonymous record is what keeps the free door free
  of amplification: a record costs one frame and reaches one topic's
  subscribers however many names it carries.
...
- [BRC-30: Extended Format Transaction](./0030.md)
  — bare-transaction grammar sharing the open port
...
- BRC-143 / BRC-144 (Multicast Subtree Data / Block Push Frame Formats)
  — push-lane format precedent
- [BRC-148: Multicast Shard Domain Partitioning and the BEEF Object Plane](./0148.md)
