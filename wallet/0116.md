...
For the distinct role of optional protocol, basket and certificate-type descriptions, see the proposed [BRC-184 metadata-registry framework](./0184.md). Registry publisher selection is not itself a permission grant or certificate-issuer endorsement. That companion proposal describes fallback and stewardship expectations; it does not change this specification's permission lifecycle.
