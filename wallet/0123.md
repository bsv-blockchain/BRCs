...
## Relationship to descriptive metadata

This scheme-ID registry is distinct from BasketMap, which publishes optional friendly descriptions of basket identifiers. The proposed [BRC-184](./0184.md) explains descriptive metadata and its limited stewardship role. A BasketMap listing does not register a `p ` scheme, install a permission module or override the module-support rules in this specification.
